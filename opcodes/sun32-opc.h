...
typedef enum cgen_insn_type {
  SUN32_INSN_INVALID, SUN32_INSN_LDA_HI, SUN32_INSN_LDA_LO, SUN32_INSN_ADD
 , SUN32_INSN_SUB, SUN32_INSN_SLL, SUN32_INSN_SRL, SUN32_INSN_SRA
 , SUN32_INSN_XOR, SUN32_INSN_OR, SUN32_INSN_AND, SUN32_INSN_MULT
 , SUN32_INSN_MULTU, SUN32_INSN_DIV, SUN32_INSN_DIVU, SUN32_INSN_CMP
 , SUN32_INSN_ADDI, SUN32_INSN_SUBI, SUN32_INSN_SLLI, SUN32_INSN_SRLI
...
#define MAX_INSNS ((int) SUN32_INSN_RETPC + 1)
