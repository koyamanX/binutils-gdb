...
/* Instruction building/extraction support for sun32. -*- C -*-
...
const char * sun32_cgen_insert_operand
...
const char *
sun32_cgen_insert_operand (CGEN_CPU_DESC cd,
			     int opindex,
			     CGEN_FIELDS * fields,
			     CGEN_INSN_BYTES_PTR buffer,
			     bfd_vma pc ATTRIBUTE_UNUSED)
{
  ...
  switch (opindex)
    ...
    case SUN32_OPERAND_POP25 :
      errmsg = insert_normal (cd, fields->f_pop25, 0|(1<<CGEN_IFLD_SIGNED), 0, 24, 25, 32, total_length, buffer);
      break;
    case SUN32_OPERAND_RA :
      errmsg = insert_normal (cd, fields->f_ra, 0, 0, 19, 5, 32, total_length, buffer);
      break;
    case SUN32_OPERAND_RB :
      errmsg = insert_normal (cd, fields->f_rb, 0, 0, 14, 5, 32, total_length, buffer);
      break;
    ...
    case SUN32_OPERAND_T20 :
      {
        ...
        errmsg = insert_normal (cd, value, 0|(1<<CGEN_IFLD_SIGNED)|(1<<CGEN_IFLD_ABS_ADDR), 0, 0, 20, 32, total_length, buffer);
      }
      break;
...
int sun32_cgen_extract_operand
...
int
sun32_cgen_extract_operand (CGEN_CPU_DESC cd,
			     int opindex,
			     CGEN_EXTRACT_INFO *ex_info,
			     CGEN_INSN_INT insn_value,
			     CGEN_FIELDS * fields,
			     bfd_vma pc)
{
  ...
  switch (opindex)
    ...
    case SUN32_OPERAND_M9 :
      ...
      break;
    case SUN32_OPERAND_POP25 :
      length = extract_normal (cd, ex_info, insn_value, 0|(1<<CGEN_IFLD_SIGNED), 0, 24, 25, 32, total_length, pc, & fields->f_pop25);
      break;
    case SUN32_OPERAND_RA :
      length = extract_normal (cd, ex_info, insn_value, 0, 0, 19, 5, 32, total_length, pc, & fields->f_ra);
      break;
    case SUN32_OPERAND_RB :
      length = extract_normal (cd, ex_info, insn_value, 0, 0, 14, 5, 32, total_length, pc, & fields->f_rb);
      break;
    case SUN32_OPERAND_RD :
    ...
    case SUN32_OPERAND_T20 :
      {
        long value;
        length = extract_normal (cd, ex_info, insn_value, 0|(1<<CGEN_IFLD_SIGNED)|(1<<CGEN_IFLD_ABS_ADDR), 0, 0, 20, 32, total_length, pc, & value);
        value = ((((value) << (2))) + (((pc) & (-4))));
        fields->f_t20r = value;
      }
      break;
...
cgen_insert_fn * const sun32_cgen_insert_handlers[] =
{
  insert_insn_normal,
};

cgen_extract_fn * const sun32_cgen_extract_handlers[] =
{
  extract_insn_normal,
};

int sun32_cgen_get_int_operand     (CGEN_CPU_DESC, int, const CGEN_FIELDS *);
bfd_vma sun32_cgen_get_vma_operand (CGEN_CPU_DESC, int, const CGEN_FIELDS *);
...
int
sun32_cgen_get_int_operand (CGEN_CPU_DESC cd ATTRIBUTE_UNUSED,
			     int opindex,
...
bfd_vma
sun32_cgen_get_vma_operand (CGEN_CPU_DESC cd ATTRIBUTE_UNUSED,
			     int opindex,
			     const CGEN_FIELDS * fields)
{
  bfd_vma value;
...
void sun32_cgen_set_int_operand  (CGEN_CPU_DESC, int, CGEN_FIELDS *, int);
void sun32_cgen_set_vma_operand  (CGEN_CPU_DESC, int, CGEN_FIELDS *, bfd_vma);
...
void
sun32_cgen_set_int_operand (CGEN_CPU_DESC cd ATTRIBUTE_UNUSED,
			     int opindex,
			     CGEN_FIELDS * fields,
			     int value)
{
...
void
sun32_cgen_set_vma_operand (CGEN_CPU_DESC cd ATTRIBUTE_UNUSED,
			     int opindex,
			     CGEN_FIELDS * fields,
			     bfd_vma value)
{
...
void
sun32_cgen_init_ibld_table (CGEN_CPU_DESC cd)
{
  cd->insert_handlers = & sun32_cgen_insert_handlers[0];
  cd->extract_handlers = & sun32_cgen_extract_handlers[0];

  cd->insert_operand = sun32_cgen_insert_operand;
  cd->extract_operand = sun32_cgen_extract_operand;

  cd->get_int_operand = sun32_cgen_get_int_operand;
  cd->set_int_operand = sun32_cgen_set_int_operand;
  cd->get_vma_operand = sun32_cgen_get_vma_operand;
  cd->set_vma_operand = sun32_cgen_set_vma_operand;
}
