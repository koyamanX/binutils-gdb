...
const char *
sun32_cgen_parse_operand (CGEN_CPU_DESC cd,
			   int opindex,
			   const char ** strp,
			   CGEN_FIELDS * fields)
{
  ...
  switch (opindex)
    ...
    case SUN32_OPERAND_RA :
      errmsg = cgen_parse_keyword (cd, strp, & sun32_cgen_opval_h_gr, & fields->f_ra);
      break;
    case SUN32_OPERAND_RB :
      errmsg = cgen_parse_keyword (cd, strp, & sun32_cgen_opval_h_gr, & fields->f_rb);
      break;
    ...
    case SUN32_OPERAND_T20 :
      {
        bfd_vma value = 0;
        errmsg = cgen_parse_address (cd, strp, SUN32_OPERAND_T20, 0, NULL,  & value);
        fields->f_t20r = value;
      }
      break;
    case SUN32_OPERAND_T25 :
      {
        bfd_vma value = 0;
        errmsg = cgen_parse_address (cd, strp, SUN32_OPERAND_T25, 0, NULL,  & value);
        fields->f_t25p = value;
      }
      break;
    case SUN32_OPERAND_U20 :
      errmsg = cgen_parse_unsigned_integer (cd, strp, SUN32_OPERAND_U20, (unsigned long *) (& fields->f_u20));
      break;
...
cgen_parse_fn * const sun32_cgen_parse_handlers[] =
{
  parse_insn_normal,
};

void
sun32_cgen_init_asm (CGEN_CPU_DESC cd)
{
  sun32_cgen_init_opcode_table (cd);
  sun32_cgen_init_ibld_table (cd);
  cd->parse_handlers = & sun32_cgen_parse_handlers[0];
  cd->parse_operand = sun32_cgen_parse_operand;
...
/* Regex construction routine.
   ...
   later use by sun32_cgen_assemble_insn

   Returns NULL for success, an error message for failure.  */

char *
sun32_cgen_build_insn_regex (CGEN_INSN *insn)
{
...
const CGEN_INSN *
sun32_cgen_assemble_insn (CGEN_CPU_DESC cd,
			   const char *str,
			   CGEN_FIELDS *fields,
  ...
  for ( ; ilist != NULL ; ilist = CGEN_ASM_NEXT_INSN (ilist))
    {
	 ...
	 shouldn't be in the hash lists.  */
      ...
      if (! sun32_cgen_insn_supported (cd, insn))
	continue;
#endif
